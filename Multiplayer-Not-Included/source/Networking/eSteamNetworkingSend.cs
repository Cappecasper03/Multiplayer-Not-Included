...
namespace MultiplayerNotIncluded.Networking.Packets
{
    ...
    /// </summary>
    [Flags]
    public enum eSteamNetworkingSend
    {
        /// <summary>
        ...
        /// </summary>
        kUnreliableNoNagle = kUnreliable | kNoNagle,
        ...
        /// </summary>
        kUnreliableNoDelay = kUnreliable | kNoDelay | kNoNagle,
        ...
        /// </summary>
        kReliableNoNagle = kReliable | kNoNagle
    }
}